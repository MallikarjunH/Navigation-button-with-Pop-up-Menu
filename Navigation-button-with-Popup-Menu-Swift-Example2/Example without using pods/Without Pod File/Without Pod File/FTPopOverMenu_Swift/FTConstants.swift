...
struct FT {
    ...
    internal static let DefaultMenuIconSize = CGFloat(24) // you can icon size here
    ...
    internal static let DefaultMenuWidth = CGFloat(200) // default 120
    internal static let DefaultTintColor = UIColor.white
